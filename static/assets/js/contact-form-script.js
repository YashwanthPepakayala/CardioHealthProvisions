...
(function($) {
    ...
    function submitForm() {
        ...
        $.ajax({
            ...
            url: "/submit_form",
            data: formData,
            dataType: "json", // Explicitly specifying the expected response type
            ...
            error: function(xhr, status, error) {
                formError();
                submitMSG(false, "Form submission error: " + error);
            }
        });
    }
